     ...
     <div class="container-login-register">
        <div class="wrap-login-register">
            <div class="login-register-form-title" style="background-image: url({{url('/images/login.jpg')}});">
                ...
                <h2 class="white-text">Recuperar sesión</h2>
            </div>
            <form method="POST" class="login-register-form" action="{{ route('password.email') }}">
                @csrf
                ...
                <div class="wrap-button" >
                    <button type="submit" class="main-button icon-button">{{ __('Enviar') }}</button>
                </div>
            </form>
        </div>
    </div>
