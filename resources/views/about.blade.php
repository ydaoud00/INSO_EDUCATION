    ...
    <div class="container">
        ...
        <div class="row">
            <table>
                <tr>
                    <td>
                        <img class="img-responsive about-img pull-left"  src="{{url('/images/me.png')}}">
                ...
                <tr>
                    ...
                    <td>  
                        <img class="mg-responsive about-img" src="{{url('/images/app.png')}}">
                ...
                <tr>
                    <td>
                        <img class="img-responsive about-img pull-left"  src="{{url('/images/goal.png')}}">
