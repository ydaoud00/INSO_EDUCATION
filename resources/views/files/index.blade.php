...
<div class="row row-offcanvas row-offcanvas-left">
   ...
   <div class="col-sm-9 col-md-10 main">
        ...
        <div class="panel profile-info">
          ...
          {{ Form::open(array('route' => array('subjects.files.store', $subject->id), 'files' => true)) }}

              {{ Form::textarea('description', Input::old('description'), array('placeholder'=>'Introduce una descripción del archivo', 'class' => 'form-control', 'rows' =>2, 'required' => 'required')) }}

              <footer class="panel-footer">
                {{ Form::submit('Compartir', array('class' => 'main-button icon-button pull-right')) }}
